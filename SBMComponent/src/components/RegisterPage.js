...
function RegisterPage() {
  ...
  const handleSubmit = (e) => {
    ...
    const registrationData = {
      ...
      bio: formData.bio,
      meetLink: formData.meetLink, // Include the meet link in the registration data
    };
        ...
        <div className="register-container">
          <form onSubmit={handleSubmit}>
            ...
            <input
              type="text"
              name="meetLink"
              placeholder="Meeting Link (Google Meet or Zoom)"
              ...
              {interestsOptions.map((interest) => (
                <div
                  ...
                  className={`interest-bubble ${
                    formData.interests.includes(interest.interestId)
                      ? "selected"
                      : ""
                  }`}
